...
(function (canvas) {
    ...
    function render() {
        ...
        context.font = "bold 30px Arial"; // font style
        context.textAlign = "center"; // center alignment

        // Draw the first line of text
        context.fillText("I Love You", canvas.width / 2, canvas.height / 2 - 10);

        // Draw the second line of text
        context.fillText("Arasha Cantika Putriaulia", canvas.width / 2, canvas.height / 2 + 20);
            }
